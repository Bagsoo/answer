...
class _BoardPostDetailScreenState extends State<BoardPostDetailScreen> {
  ...
  Future<void> _sharePostToChat(Map<String, dynamic> post) async {
    ...
    if (!mounted) return;
    messenger.showSnackBar(const SnackBar(content: Text('채팅방에 게시글을 공유했습니다.')));
  }
          ...
          ElevatedButton(
            ...
            onPressed: () async {
              ...
              if (mounted) {
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content: Text(ok ? l.postDeleted : l.postSaveFailed),
                  ),
                );
                    ...
                    children: [
                      ...
                      FutureBuilder<UserDisplayData>(
                        future: UserDisplay.resolve(
                          postAuthorId,
                          fallbackName: post['author_name'] as String? ?? '',
                        ),
                        builder: (context, authorSnap) {
                          ...
                          final authorName = author.displayName(
                            l,
                            fallback: post['author_name'] as String? ?? '',
                          );
                          return Row(
                            children: [
                              Text(
                        ...
                        builder: (context, commentSnap) {
                          ...
                          return Column(
                            children: comments.map((comment) {
                              ...
                              final authorId =
                                  comment['author_id'] as String? ?? '';
                              final cachedAuthor = UserDisplay.resolveCached(
                                authorId,
                                fallbackName:
                ...
                child: Container(
                  ...
                  child: StreamBuilder<DocumentSnapshot>(
                    ...
                    builder: (context, mySnap) {
                      ...
                      final myName = myData?['display_name'] as String? ?? '';
                      return Row(
                        children: [
                          Expanded(
                            child: TextField(
