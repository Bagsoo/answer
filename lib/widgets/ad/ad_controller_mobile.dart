...
class AdController extends ChangeNotifier {
  static const _adUnitAndroid = 'ca-app-pub-3940256099942544/2247696110';
  static const _adUnitIos     = 'ca-app-pub-3940256099942544/3986624511';
  ...
  Future<void> load({
    ...
    final success = await completer.future.timeout(_kTimeout, onTimeout: () {
      ad.dispose();
      return false;
    });
